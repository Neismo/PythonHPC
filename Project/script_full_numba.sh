...
### -- set the job Name -- 
#BSUB -J simulate_all_floors_numba
...
#BSUB -o logs/simulate_all_floors_numba.out 
#BSUB -e logs/simulate_all_floors_numba.err 

source /dtu/projects/02613_2025/conda/conda_init.sh
conda activate 02613_2026

python -u simulate_dynamic_numba.py 4571 16
